...
export default function ScoresData({ teams, venue, gameId, status }: Props) {
	...
	let hLogoUrl = `${LOGO_URL}/${teams.home.team.id}.svg`;
	let aLogoUrl = `${LOGO_URL}/${teams.away.team.id}.svg`;
				...
				<Grid
					...
					<Grid item xs={2} pl={5}>
						<Typography
							...
							variant='h3'
							className={`${
								winningTeam === 'away' ? 'winning-team' : 'losing-team'
							}`}>
							{teams.away.score}
						</Typography>
					</Grid>
				...
				<Grid
					...
					<Grid item xs={4} pl={5}>
						<Typography
							...
							variant='h3'
							className={`${
								winningTeam === 'home' ? 'winning-team' : 'losing-team'
							}`}>
							{teams.home.score}
						</Typography>
					</Grid>
